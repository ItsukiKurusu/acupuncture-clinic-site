          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 pt-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">BODY</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">FACE</h3>
                  <p className="text-gray-500 text-sm">眼精疲労の緩和、リフトアップ効果。</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">FOOT</h3>
                  <p className="text-gray-500 text-sm">下肢の血行促進、むくみの軽減</p>
                </div>
              </div>
            </div>
          </div>
